...
class CustomerFilter(django_filters.FilterSet):
    # filters customers whose name contains a string, case-insensitive.
    name_icontains = django_filters.CharFilter(field_name="name", lookup_expr="icontains")
    
    # filters customers whose email contains a string, case-insensitive.
    email_icontains = django_filters.CharFilter(field_name="email", lookup_expr="icontains")
    
    # filters customers created after / before a date.
    ...
    # custom filter cystomers with phone numbers that start with a particular value.
